                ...
                <form onSubmit={handleSubmit(onSubmit)} className="grid gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full rounded-2xl border border-gray-200 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                        {errors.emergencyPhone && <p className="mt-2 text-sm text-red-600">{errors.emergencyPhone.message}</p>}
                    </div>
                    ...
                    <div className="md:col-span-2 flex items-center gap-3">
                        ...
                        <Link to="/owner/guests" className="rounded-2xl border border-gray-200 bg-white px-6 py-3 text-gray-700 font-semibold hover:bg-gray-50">
                            Cancel
                        </Link>
                    </div>
                </form>
